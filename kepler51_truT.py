...
if __name__ == "__main__":
    ...
    historic_snapshot_period = 365.25 # days
  ...
  #FIRST outside 2:1
    ...
    planet_l = (0.0, 145.24391693342372, 213.68515767464623, 219.15542825142626)  #nominal from mean longitude #?(model dolgota voshod yzel = 0) normirovan na 2*pi четвертую приня ##=0 так как нет данных и серван опридется возиться с положениями 
