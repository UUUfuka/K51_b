...
def is_resonance(res, g_inner, n_inner, M_inner, g_outer, n_outer, M_outer, nb_points=50, angle_center_value=0, std_threshold=20.):
    ...
    phi = np.empty((q+1, int(nb_points))) # we create an array, empty for the moment, that will contain all the resonant angles associated with the supposed resonance.
