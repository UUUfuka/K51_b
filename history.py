...
def classify(n_particles, data, reference_particle_index=0, discard_first_hundred_years=False):
    ...
    for key in planets_keys:
        ...
        planets_data[key] = append_fields(planets_data[key], ('semi-major_axis', 'eccentricity', 'inclination','longitude_of_perihelion','longitude_of_ascending_node','mean_anomaly'), (a, e, i,p,n,l), usemask=False)
